...
import com.moing.backend.domain.team.application.service.CreateTeamUseCase;
import com.moing.backend.domain.team.application.service.DisbandTeamUseCase;
import com.moing.backend.domain.team.application.service.GetTeamUseCase;
import com.moing.backend.domain.team.application.service.ReviewTeamUseCase;
import com.moing.backend.domain.team.application.service.SignInTeamUseCase;
import com.moing.backend.domain.team.application.service.UpdateTeamUseCase;
import com.moing.backend.domain.team.application.service.WithdrawTeamUseCase;
...
public class TeamController {
	...
	public ResponseEntity<SuccessResponse<CreateTeamResponse>> createTeam(@AuthenticationPrincipal User user,
		...
		return ResponseEntity.ok(SuccessResponse.create(CREATE_TEAM_SUCCESS.getMessage(),
			this.createTeamService.createTeam(createTeamRequest, user.getSocialId())));
	}
	...
	public ResponseEntity<SuccessResponse<GetTeamResponse>> getTeam(@AuthenticationPrincipal User user) {
		return ResponseEntity.ok(
			SuccessResponse.create(GET_TEAM_SUCCESS.getMessage(), this.getTeamUseCase.getTeam(user.getSocialId())));
	}
	...
	public ResponseEntity<SuccessResponse<GetTeamDetailResponse>> getTeamDetail(@AuthenticationPrincipal User user,
		...
		return ResponseEntity.ok(SuccessResponse.create(GET_TEAM_DETAIL_SUCCESS.getMessage(),
			this.getTeamUseCase.getTeamDetailResponse(user.getSocialId(), teamId)));
	}
	...
	public ResponseEntity<SuccessResponse<CreateTeamResponse>> signInTeam(@AuthenticationPrincipal User user,
		@PathVariable Long teamId) {
		return ResponseEntity.ok(SuccessResponse.create(SIGNIN_TEAM_SUCCESS.getMessage(),
			this.signInTeamUseCase.signInTeam(user.getSocialId(), teamId)));
	}
	...
	public ResponseEntity<SuccessResponse<DeleteTeamResponse>> disbandTeam(@AuthenticationPrincipal User user,
		@PathVariable Long teamId) {
		return ResponseEntity.ok(SuccessResponse.create(DISBAND_TEAM_SUCCESS.getMessage(),
			this.disbandTeamUseCase.disbandTeam(user.getSocialId(), teamId)));
	}
	...
	public ResponseEntity<SuccessResponse<DeleteTeamResponse>> withdrawTeam(@AuthenticationPrincipal User user,
		@PathVariable Long teamId) {
		return ResponseEntity.ok(SuccessResponse.create(WITHDRAW_TEAM_SUCCESS.getMessage(),
			this.withdrawTeamUseCase.withdrawTeam(user.getSocialId(), teamId)));
	}
	...
	public ResponseEntity<SuccessResponse<ReviewTeamResponse>> reviewTeam(@AuthenticationPrincipal User user,
		@PathVariable Long teamId) {
		return ResponseEntity.ok(SuccessResponse.create(REVIEW_TEAM_SUCCESS.getMessage(),
			this.reviewTeamUseCase.reviewTeam(user.getSocialId(), teamId)));
	}
	...
	@PutMapping("/{teamId}")
	public ResponseEntity<SuccessResponse<UpdateTeamResponse>> updateTeam(
		@Valid @RequestBody UpdateTeamRequest updateTeamRequest,
		@AuthenticationPrincipal User user,
		@PathVariable Long teamId) {
		return ResponseEntity.ok(SuccessResponse.create(UPDATE_TEAM_SUCCESS.getMessage(),
			this.updateTeamUseCase.updateTeam(updateTeamRequest, user.getSocialId(), teamId)));
	}
	 ...
	 */
	@GetMapping("/{teamId}")
	public ResponseEntity<SuccessResponse<GetCurrentStatusResponse>> getCurrentStatus(
		@AuthenticationPrincipal User user,
		@PathVariable Long teamId) {
		return ResponseEntity.ok(SuccessResponse.create(GET_CURRENT_STATUS_SUCCESS.getMessage(),
			this.getTeamUseCase.getCurrentStatus(teamId)));
	}
	...
	public ResponseEntity<SuccessResponse<GetTeamCountResponse>> getTeamCount(@AuthenticationPrincipal User user,
		@PathVariable Long teamId) {
		return ResponseEntity.ok(SuccessResponse.create(GET_TEAM_COUNT_SUCCESS.getMessage(),
			this.getTeamUseCase.getTeamCount(user.getSocialId(), teamId)));
	}
