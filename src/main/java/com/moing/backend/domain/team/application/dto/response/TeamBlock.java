...
public class TeamBlock {
	...
	@QueryProjection
	public TeamBlock(Long teamId, LocalDateTime approvalTime, Integer levelOfFire, String teamName, Integer numOfMember,
		String category, LocalDateTime deletionTime, String profileImgUrl) {
		this.teamId = teamId;
