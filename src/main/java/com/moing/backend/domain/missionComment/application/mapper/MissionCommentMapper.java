...
public class MissionCommentMapper {
	public static MissionComment toMissionComment(TeamMember teamMember, MissionArchive missionArchive,
		CreateCommentRequest createCommentRequest, boolean isLeader) {
