...
import static com.moing.backend.domain.missionComment.domain.entity.QMissionComment.*;
...
public class MissionCommentCustomRepositoryImpl implements MissionCommentCustomRepository {
	...
	public GetCommentResponse findMissionCommentAll(Long missionArchiveId, TeamMember teamMember) {
		...
		BooleanExpression blockCondition = BlockRepositoryUtils.blockCondition(teamMember.getTeamMemberId(),
	...
	public Optional<List<NewUploadInfo>> findNewUploadInfo(Long memberId, Long missionArchiveId) {
		BooleanExpression blockCondition = BlockRepositoryUtils.blockCondition(
			missionComment.teamMember.member.memberId, memberId);
