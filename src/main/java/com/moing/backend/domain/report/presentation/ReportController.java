...
public class ReportController {
	...
	public ResponseEntity<SuccessResponse<Long>> createReport(@AuthenticationPrincipal User user,
		...
		return ResponseEntity.ok(SuccessResponse.create(CREATE_REPORT_SUCCESS.getMessage(),
			this.reportCreateUseCase.createReport(user.getSocialId(), targetId, reportType)));
	}
}
