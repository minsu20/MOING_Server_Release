...
public class MissionArchiveMapper {
	...
	public static MissionArchive mapToMissionArchive(MissionArchiveReq missionArchiveReq, Member member,
		Mission mission) {
	...
	public static List<MissionArchiveRes> mapToMissionArchiveResList(List<MissionArchive> missionArchiveList,
		...
		missionArchiveList.forEach(
			missionArchive -> missionArchiveResList.add(
				MissionArchiveMapper.mapToMissionArchiveRes(missionArchive, memberId))
		);
	...
	public static List<PersonalArchiveRes> mapToPersonalArchiveList(List<MissionArchive> missionArchiveList,
		...
		missionArchiveList.forEach(
			missionArchive -> personalArchiveList.add(
				MissionArchiveMapper.mapToPersonalArchive(missionArchive, memberId))
		);
	...
	public static List<SingleMissionBoardRes> mapToSingleMissionBoardResList(List<MissionArchive> missionArchives) {
		...
		missionArchives.forEach(
			missionArchive -> singleMissionBoardResList.add(
				MissionArchiveMapper.mapToSingleMissionBoardRes(missionArchive))
		);

		return singleMissionBoardResList;
	}

	public static MissionArchiveHeartRes mapToMissionArchiveHeartRes(MissionArchive missionArchive,
		Boolean heartStatus) {
	...
	public static List<FinishMissionBoardRes> mapToFinishMissionBoardResList(List<MissionArchive> missionArchives) {
		...
		missionArchives.forEach(
			missionArchive -> finishMissionBoardResList.add(
				MissionArchiveMapper.mapToFinishMissionBoardRes(missionArchive))
		);
