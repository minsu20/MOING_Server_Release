...
import com.moing.backend.domain.missionArchive.application.service.MissionArchiveDeleteUseCase;
...
import com.moing.backend.domain.missionArchive.application.service.RepeatMissionArchiveReadUseCase;
...
public class MissionArchiveController {
	...
	public ResponseEntity<SuccessResponse<MissionArchiveRes>> createArchive(@AuthenticationPrincipal User user,
		...
		return ResponseEntity.ok(SuccessResponse.create(CREATE_ARCHIVE_SUCCESS.getMessage(),
			this.missionArchiveCreateUseCase.createArchive(user.getSocialId(), missionId, missionArchiveReq)));
	}
	...
	public ResponseEntity<SuccessResponse<MissionArchiveRes>> updateArchive(@AuthenticationPrincipal User user,
		...
		return ResponseEntity.ok(SuccessResponse.create(UPDATE_ARCHIVE_SUCCESS.getMessage(),
			this.missionArchiveUpdateUseCase.updateArchive(user.getSocialId(), missionId, missionArchiveReq)));
	}
	...
	public ResponseEntity<SuccessResponse<Long>> deleteArchive(@AuthenticationPrincipal User user,
		...
		return ResponseEntity.ok(SuccessResponse.create(DELETE_ARCHIVE_SUCCESS.getMessage(),
			this.missionArchiveDeleteUseCase.deleteArchive(user.getSocialId(), missionId, count)));
	}
	...
	public ResponseEntity<SuccessResponse<MyMissionArchiveRes>> getMyArchive(@AuthenticationPrincipal User user,
		@PathVariable("teamId") Long teamId,
		@PathVariable("missionId") Long missionId) {
		return ResponseEntity.ok(SuccessResponse.create(READ_MY_ARCHIVE_SUCCESS.getMessage(),
			this.missionArchiveReadUseCase.getMyArchive(user.getSocialId(), missionId)));
	}
	 ...
	 **/
	@GetMapping("/others")
	public ResponseEntity<SuccessResponse<List<PersonalArchiveRes>>> getOtherPeopleArchives(
		@AuthenticationPrincipal User user,
		@PathVariable("teamId") Long teamId,
		@PathVariable("missionId") Long missionId) {
		return ResponseEntity.ok(SuccessResponse.create(READ_TEAM_ARCHIVE_SUCCESS.getMessage(),
			this.missionArchiveReadUseCase.getPersonalArchive(user.getSocialId(), missionId)));
	}
	...
	public ResponseEntity<SuccessResponse<MissionHeartRes>> pushHeart(@AuthenticationPrincipal User user,
		...
		return ResponseEntity.ok(SuccessResponse.create(CREATE_ARCHIVE_SUCCESS.getMessage(),
			this.missionHeartUseCase.pushHeart(user.getSocialId(), archiveId, missionHeartStatus)));
	}
	...
	@GetMapping("/status")
	public ResponseEntity<SuccessResponse<MissionArchiveStatusRes>> getMissionDoneStatus(
		@AuthenticationPrincipal User user,
		@PathVariable("teamId") Long teamId,
		@PathVariable("missionId") Long missionId) {
		return ResponseEntity.ok(SuccessResponse.create(MISSION_ARCHIVE_PEOPLE_STATUS_SUCCESS.getMessage(),
			this.missionArchiveReadUseCase.getMissionDoneStatus(missionId)));
	}
	...
	public ResponseEntity<SuccessResponse<MissionArchiveStatusRes>> getMyMissionDoneStatus(
		@AuthenticationPrincipal User user,
		@PathVariable("teamId") Long teamId,
		@PathVariable("missionId") Long missionId) {
		return ResponseEntity.ok(SuccessResponse.create(MISSION_ARCHIVE_PEOPLE_STATUS_SUCCESS.getMessage(),
			this.repeatMissionArchiveReadUseCase.getMyMissionDoneStatus(user.getSocialId(), missionId)));
	}
	...
	public ResponseEntity<SuccessResponse<MyArchiveStatus>> getMyMissionStatus(@AuthenticationPrincipal User user,
		...
		@PathVariable("missionId") Long missionId) {
		return ResponseEntity.ok(SuccessResponse.create(MISSION_ARCHIVE_PEOPLE_STATUS_SUCCESS.getMessage(),
			this.missionArchiveReadUseCase.getMissionArchiveStatus(user.getSocialId(), missionId, teamId)));
	}
