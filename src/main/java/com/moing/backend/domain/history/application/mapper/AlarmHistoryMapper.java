...
public class AlarmHistoryMapper {
	...
	public static AlarmHistory toAlarmHistory(AlarmType type, String path, String idInfo, Long receiverId, String title,
	...
	public static List<AlarmHistory> getAlarmHistories(String idInfo, List<Long> memberIds, String title, String body,
		String teamName, AlarmType alarmType, String path) {
		return memberIds.stream()
			.map(memberId -> toAlarmHistory(alarmType, path, idInfo, memberId, title, body, teamName))
			.collect(Collectors.toList());
	}

	public static Optional<List<MemberIdAndToken>> getNewUploadSaveInfo(
		Optional<List<NewUploadInfo>> optionalNewUploadInfos) {
	...
	public static Optional<List<MemberIdAndToken>> getNewUploadPushInfo(
		Optional<List<NewUploadInfo>> optionalNewUploadInfos) {
		return optionalNewUploadInfos.map(newUploadInfos ->
			newUploadInfos.stream()
