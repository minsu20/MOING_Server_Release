...
public class SaveSingleAlarmHistoryUseCase {
	...
	@Async
	public void saveAlarmHistory(Long memberId, String idInfo, String title, String body, String name,
		AlarmType alarmType, String path) {
		AlarmHistory alarmHistory = AlarmHistoryMapper.toAlarmHistory(alarmType, path, idInfo, memberId, title, body,
			name);
