...
public class GetAlarmHistoryResponse {
	...
	@QueryProjection
	public GetAlarmHistoryResponse(Long alarmHistoryId, AlarmType type, String path, String idInfo, String title,
		String body, String name, boolean isRead, LocalDateTime createdDate) {
