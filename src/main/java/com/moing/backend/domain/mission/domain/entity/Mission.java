...
public class Mission extends BaseTimeEntity {
	...
	@Builder
	public Mission(String title, LocalDateTime dueTo, String rule, String content, int number, Team team,
		MissionType type, MissionStatus status, MissionWay way, Long makerId) {
		this.title = title;
		this.dueTo = dueTo;
		this.rule = rule;
