...
public class CommentBlocks {
	...
	@QueryProjection
	public CommentBlocks(Long commentId, String content, String writerNickName, Boolean writerIsLeader,
		String writerProfileImage, Boolean isWriter, Boolean writerIsDeleted, LocalDateTime createdDate, Long makerId) {
