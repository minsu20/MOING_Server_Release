...
public class BoardBlocks {
	...
	@QueryProjection
	public BoardBlocks(Long boardId, String writerNickName, Boolean writerIsLeader, String writerProfileImage,
		String title, String content, Integer commentNum, Boolean isRead, Boolean writerIsDeleted, boolean isNotice,
		Long makerId) {
