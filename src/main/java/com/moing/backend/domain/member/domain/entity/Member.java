...
public class Member extends BaseTimeEntity {
	...
	public Member(LocalDate birthDate, String email, String fcmToken, Gender gender, String introduction,
		String nickName, String profileImage, SocialProvider provider, RegistrationStatus registrationStatus, Role role,
		String socialId) {
		this.birthDate = birthDate;
		this.email = email;
		this.fcmToken = fcmToken;
