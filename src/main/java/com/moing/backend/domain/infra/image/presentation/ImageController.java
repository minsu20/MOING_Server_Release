...
public class ImageController {
	...
	public ResponseEntity<SuccessResponse<IssuePresignedUrlResponse>> createPresigned(
		@RequestBody IssuePresignedUrlRequest issuePresignedUrlRequest) {

		return ResponseEntity.ok(SuccessResponse.create(EImageResponseMessage.ISSUE_PRESIGNED_URL_SUCCESS.getMessage(),
